    ...
    <Section>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {project.flats.map((flat, index) => (
          <FadeIn key={flat.id} delay={index * 0.1} className="h-full">
            <article className="group flex h-full flex-col overflow-hidden rounded-sm border border-navy/10 bg-white shadow-soft transition-shadow hover:shadow-card">
