...
export const project: ProjectData = {
  ...
  brands: [
    { name: "Asian Paints", logo: "/images/brands/asian-paints.svg" },
    { name: "Astral Pipes", logo: "/images/brands/astral-pipes.png" },
    { name: "Cera", logo: "/images/brands/cera.svg" },
    { name: "Parryware", logo: "/images/brands/parryware.png" },
    { name: "Kajaria", logo: "/images/brands/kajaria.svg" },
    { name: "AGL", logo: "/images/brands/agl.png" },
    { name: "Action Tesa", logo: "/images/brands/action-tesa.png" },
    { name: "Greenlam", logo: "/images/brands/greenlam.png" },
    { name: "Merino", logo: "/images/brands/merino.png" },
    { name: "Virgo", logo: "/images/brands/virgo.svg" },
  ],
  contact: {
